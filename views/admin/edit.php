					...
					<fieldset>
						<ul>
							<li>
								...
								<div class="input">
									<input type="text" name="name" placeholder="Client Name" value="<?php echo $testimonial->name; ?>"></input>
								</div>
							</li>
							<li>
								...
								<div class="input">
									<input id="testimonial-url" type="text" name="website_url" placeholder="http://example.com" value="<?php echo $testimonial->website_url; ?>"></input>
								</div>
							</li>
							<li class="editor">
								...
								<div class="edit-content">
									<?php echo form_textarea(array('id' => 'testimonial-bio', 'name' => 'testimonial_bio', 'value' => $testimonial->bio, 'rows' => 30, 'class' => 'wysiwyg-simple')) ?>
								</div>
							</li>
							<li class="editor">
								...
								<div class="edit-content">
									<?php echo form_textarea(array('id' => 'testimonial-text', 'name' => 'testimonial_text', 'value' => $testimonial->text, 'rows' => 30, 'class' => 'wysiwyg-simple')) ?>
								</div>
							</li>
							<li>
								<label for="status">Status</label>
								<div class="input"><?php echo form_dropdown('status', array('0' => 'Draft', '1' => 'Live'), $testimonial->status, 'id="status"') ?></div>
							</li>
						</ul>
					</fieldset>
